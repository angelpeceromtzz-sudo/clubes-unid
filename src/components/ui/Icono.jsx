...
const ICONOS = {
  ...
  clipboard: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10',
  ...
  'location-point': 'M15 11a3 3 0 11-6 0 3 3 0 016 0z',
  ...
  login: 'M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1',
  ...
  'map-pin': 'M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z',
...
export function Icono({ nombre, className = 'h-5 w-5', strokeWidth = 1.5 }) {
  const d = ICONOS[nombre];
  if (!d) {
    console.warn(`Icono "${nombre}" no encontrado`);
    return null;
  }
  return (
