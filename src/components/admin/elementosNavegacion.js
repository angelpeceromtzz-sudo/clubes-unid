/* Configuración de elementos de navegación para los paneles de Admin, Rectoría y Presidente. */
...
export const ELEMENTOS_NAV_PRESIDENTE = [
  ...
  { key: 'solicitudes', label: 'Formularios', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  ...
  { key: 'seleccion-final', label: 'Selección Final', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
];
